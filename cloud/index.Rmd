...
+ This Shiny app loads a pre-trained Keras model which can recognise common objects (particularly, cats and dogs) from a given picture.

+ On Google Cloud (the latter use Docker), the app keeps crashing and restarting. The log on `shinyapp.io` makes me think that it also uses Docker. 
