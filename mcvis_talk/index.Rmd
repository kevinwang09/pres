...
author: "[Kevin Y. X. Wang](https://kevinwang09.github.io/) `r icon::fa('twitter')` KevinWang009"
date: "5th December 2019, Adelaide, 'Straya"
output:
...
+ Note that this only implicates the existence of MC, not which variable causes MC. 
...
So that a larger $\tau_p$ value implies great MC.  
...
.blockquote[
Exploit the linearity between $\tau_p$ and each VIFs (easier), to diagnose MC-causing variables (complex).
]
